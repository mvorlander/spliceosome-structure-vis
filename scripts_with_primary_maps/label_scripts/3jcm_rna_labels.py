...
_EMBEDDED_SPEC_JSON = '{\n  "background": "none",\n  "cleanup_model_ids": [\n    "302.1.90"\n  ],\n  "default_visible_category_keys": [\n    "pre_mRNA_features",\n    "snRNA_pre_mRNA_regions"\n  ],\n  "default_visible_category_names": [\n    "pre-mRNA features",\n    "snRNA-pre-mRNA regions"\n  ],\n  "height": 3.35,\n  "label_group_model_id": "302.2",\n  "label_group_name": "RNA_feature_labels",\n  "labels": [\n    {\n      "atomspec": "#302.1/C:-1",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "302.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#FF8C00",\n      "default_visible": true,\n      "feature": "exon_5",\n      "index": 1,\n      "label_model_id": "302.2.1.1",\n      "model_name": "label_01_5_exon_res_6_4",\n      "selector_name": "U5_tri_snRNP_3JCM_5exon",\n      "text": "5\' exon (res. -6-4)"\n    },\n    {\n      "atomspec": "#302.1/C:8",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "302.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "five_prime_splice_site",\n      "index": 2,\n      "label_model_id": "302.2.1.2",\n      "model_name": "label_02_5_SS_res_5_10",\n      "selector_name": "U5_tri_snRNP_3JCM_5SS",\n      "text": "5\'SS (res. 5-10)"\n    },\n    {\n      "atomspec": "#302.1/C:9",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "302.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "intron",\n      "index": 3,\n      "label_model_id": "302.2.1.3",\n      "model_name": "label_03_intron_res_5_13",\n      "selector_name": "U5_tri_snRNP_3JCM_intron",\n      "text": "intron (res. 5-13)"\n    },\n    {\n      "atomspec": "#302.1/E:10",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "302.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#D8C800",\n      "default_visible": false,\n      "feature": "U4_U6_stem_I_partner",\n      "index": 4,\n      "label_model_id": "302.2.2.1",\n      "model_name": "label_04_U4_U6_stem_I_res_1_18",\n      "selector_name": "U5_tri_snRNP_3JCM_U4_U6_stem_I_partner",\n      "text": "U4/U6 stem I (res. 1-18)"\n    },\n    {\n      "atomspec": "#302.1/E:60",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "302.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#E0CF1A",\n      "default_visible": false,\n      "feature": "U4_U6_stem_II_partner",\n      "index": 5,\n      "label_model_id": "302.2.2.2",\n      "model_name": "label_05_U4_U6_stem_II_res_57_64",\n      "selector_name": "U5_tri_snRNP_3JCM_U4_U6_stem_II_partner",\n      "text": "U4/U6 stem II (res. 57-64)"\n    },\n    {\n      "atomspec": "#302.1/E:62",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "302.2.3",\n      "category_name": "other snRNA regions",\n      "color": "#F0DF2E",\n      "default_visible": false,\n      "feature": "U4_Brr2_loading_region",\n      "index": 6,\n      "label_model_id": "302.2.3.1",\n      "model_name": "label_06_U4_Brr2_region_res_60_64",\n      "selector_name": "U5_tri_snRNP_3JCM_U4_Brr2_loading_region",\n      "text": "U4 Brr2 region (res. 60-64)"\n    },\n    {\n      "atomspec": "#302.1/F:53",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "302.2.4",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#1B3CD0",\n      "default_visible": true,\n      "feature": "U5_loop_I",\n      "index": 7,\n      "label_model_id": "302.2.4.1",\n      "model_name": "label_07_U5_loop_I_res_53",\n      "selector_name": "U5_tri_snRNP_3JCM_U5_loop_I",\n      "text": "U5 loop I (res. 53)"\n    },\n    {\n      "atomspec": "#302.1/D:61",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "302.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#D0183C",\n      "default_visible": false,\n      "feature": "U6_U2_helix_I_partner",\n      "index": 8,\n      "label_model_id": "302.2.2.3",\n      "model_name": "label_08_U2_U6_helix_I_res_44_52_56_66",\n      "selector_name": "U5_tri_snRNP_3JCM_U6_U2_helix_I_partner",\n      "text": "U2/U6 helix I (res. 44-52;56-66)"\n    },\n    {\n      "atomspec": "#302.1/D:48",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "302.2.4",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#E01842",\n      "default_visible": true,\n      "feature": "U6_5SS_upstream_contact",\n      "index": 9,\n      "label_model_id": "302.2.4.2",\n      "model_name": "label_09_U6_5_SS_contact_res_44_52",\n      "selector_name": "U5_tri_snRNP_3JCM_U6_5SS_upstream_contact",\n      "text": "U6 5\'SS contact (res. 44-52)"\n    },\n    {\n      "atomspec": "#302.1/D:64",\n      "category_key": "internal_stem_loops",\n      "category_model_id": "302.2.5",\n      "category_name": "internal stem loops",\n      "color": "#D61A3D",\n      "default_visible": false,\n      "feature": "U6_ISL",\n      "index": 10,\n      "label_model_id": "302.2.5.1",\n      "model_name": "label_10_U6_ISL_res_46_52_56_73",\n      "selector_name": "U5_tri_snRNP_3JCM_U6_ISL",\n      "text": "U6 ISL (res. 46-52;56-73)"\n    },\n    {\n      "atomspec": "#302.1/D:50",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "302.2.3",\n      "category_name": "other snRNA regions",\n      "color": "#DC143C",\n      "default_visible": false,\n      "feature": "U6_ACAGAGA_box",\n      "index": 11,\n      "label_model_id": "302.2.3.2",\n      "model_name": "label_11_U6_ACAGAGA_res_47_52",\n      "selector_name": "U5_tri_snRNP_3JCM_U6_ACAGAGA_box",\n      "text": "U6 ACAGAGA (res. 47-52)"\n    },\n    {\n      "atomspec": "#302.1/D:62",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "302.2.3",\n      "category_name": "other snRNA regions",\n      "color": "#E01842",\n      "default_visible": false,\n      "feature": "U6_U4_stem_II_partner",\n      "index": 12,\n      "label_model_id": "302.2.3.3",\n      "model_name": "label_12_U4_U6_stem_II_res_56_68",\n      "selector_name": "U5_tri_snRNP_3JCM_U6_U4_stem_II_partner",\n      "text": "U4/U6 stem II (res. 56-68)"\n    },\n    {\n      "atomspec": "#302.1/D:60",\n      "category_key": "catalytic_core_regions",\n      "category_model_id": "302.2.6",\n      "category_name": "catalytic core regions",\n      "color": "#C91236",\n      "default_visible": false,\n      "feature": "U6_AGC_catalytic_triad",\n      "index": 13,\n      "label_model_id": "302.2.6.1",\n      "model_name": "label_13_U6_AGC_triad_res_59_61",\n      "selector_name": "U5_tri_snRNP_3JCM_U6_AGC_catalytic_triad",\n      "text": "U6 AGC triad (res. 59-61)"\n    },\n    {\n      "atomspec": "#302.1/D:75",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "302.2.3",\n      "category_name": "other snRNA regions",\n      "color": "#D9183E",\n      "default_visible": false,\n      "feature": "U6_U4_stem_I_partner",\n      "index": 14,\n      "label_model_id": "302.2.3.4",\n      "model_name": "label_14_U4_U6_stem_I_res_70_80",\n      "selector_name": "U5_tri_snRNP_3JCM_U6_U4_stem_I_partner",\n      "text": "U4/U6 stem I (res. 70-80)"\n    }\n  ],\n  "outline_color": "#ffffff",\n  "outline_offsets": [\n    [\n      -0.085,\n      0,\n      0\n    ],\n    [\n      0.085,\n      0,\n      0\n    ],\n    [\n      0,\n      -0.085,\n      0\n    ],\n    [\n      0,\n      0.085,\n      0\n    ],\n    [\n      -0.06,\n      -0.06,\n      0\n    ],\n    [\n      -0.06,\n      0.06,\n      0\n    ],\n    [\n      0.06,\n      -0.06,\n      0\n    ],\n    [\n      0.06,\n      0.06,\n      0\n    ],\n    [\n      -0.052,\n      0,\n      0\n    ],\n    [\n      0.052,\n      0,\n      0\n    ],\n    [\n      0,\n      -0.052,\n      0\n    ],\n    [\n      0,\n      0.052,\n      0\n    ],\n    [\n      -0.037,\n      -0.037,\n      0\n    ],\n    [\n      -0.037,\n      0.037,\n      0\n    ],\n    [\n      0.037,\n      -0.037,\n      0\n    ],\n    [\n      0.037,\n      0.037,\n      0\n    ]\n  ],\n  "size": 144,\n  "structure_model_id": "302.1"\n}'
