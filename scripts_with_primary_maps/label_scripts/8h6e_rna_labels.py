...
_EMBEDDED_SPEC_JSON = '{\n  "background": "none",\n  "cleanup_model_ids": [\n    "379.1.90"\n  ],\n  "default_visible_category_keys": [\n    "pre_mRNA_features",\n    "snRNA_pre_mRNA_regions"\n  ],\n  "default_visible_category_names": [\n    "pre-mRNA features",\n    "snRNA-pre-mRNA regions"\n  ],\n  "height": 3.35,\n  "label_group_model_id": "379.2",\n  "label_group_name": "RNA_feature_labels",\n  "labels": [\n    {\n      "atomspec": "#379.1/A:28",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "379.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "intron",\n      "index": 1,\n      "label_model_id": "379.2.1.1",\n      "model_name": "label_01_intron_res_7_48",\n      "selector_name": "pre_B_8H6E_intron",\n      "text": "intron (res. 7-48)"\n    },\n    {\n      "atomspec": "#379.1/A:27",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "379.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "branch_point_region",\n      "index": 2,\n      "label_model_id": "379.2.1.2",\n      "model_name": "label_02_BP_region_res_24_30",\n      "selector_name": "pre_B_8H6E_branch_region",\n      "text": "BP region (res. 24-30)"\n    },\n    {\n      "atomspec": "#379.1/A:29",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "379.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "branch_point_adenosine",\n      "index": 3,\n      "label_model_id": "379.2.1.3",\n      "model_name": "label_03_BP_A_res_29",\n      "selector_name": "pre_B_8H6E_branch_A",\n      "text": "BP-A (res. 29)"\n    },\n    {\n      "atomspec": "#379.1/A:42",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "379.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "polypyrimidine_tract",\n      "index": 4,\n      "label_model_id": "379.2.1.4",\n      "model_name": "label_04_PPT_res_35_48",\n      "selector_name": "pre_B_8H6E_PPT",\n      "text": "PPT (res. 35-48)"\n    },\n    {\n      "atomspec": "#379.1/A:105",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "379.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#FF8C00",\n      "default_visible": true,\n      "feature": "exon_defined_exon",\n      "index": 5,\n      "label_model_id": "379.2.1.5",\n      "model_name": "label_05_exon_res_103_107",\n      "selector_name": "pre_B_8H6E_exon",\n      "text": "exon (res. 103-107)"\n    },\n    {\n      "atomspec": "#379.1/A:110",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "379.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "five_prime_splice_site",\n      "index": 6,\n      "label_model_id": "379.2.1.6",\n      "model_name": "label_06_5_SS_res_108_113",\n      "selector_name": "pre_B_8H6E_5SS",\n      "text": "? 5\'SS (res. 108-113)"\n    },\n    {\n      "atomspec": "#379.1/2A:30",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "379.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#047857",\n      "default_visible": false,\n      "feature": "U2_U6_helix_I_partner",\n      "index": 7,\n      "label_model_id": "379.2.2.1",\n      "model_name": "label_07_U2_U6_helix_I_res_30",\n      "selector_name": "pre_B_8H6E_U2_U6_helix_I_partner",\n      "text": "U2/U6 helix I (res. 30)"\n    },\n    {\n      "atomspec": "#379.1/2A:36",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "379.2.3",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#0B6E2D",\n      "default_visible": true,\n      "feature": "U2_branchpoint_pairing_region",\n      "index": 8,\n      "label_model_id": "379.2.3.1",\n      "model_name": "label_08_U2_BP_pairing_res_32_41",\n      "selector_name": "pre_B_8H6E_U2_branchpoint_pairing_region",\n      "text": "U2 BP pairing (res. 32-41)"\n    },\n    {\n      "atomspec": "#379.1/2A:56",\n      "category_key": "internal_stem_loops",\n      "category_model_id": "379.2.4",\n      "category_name": "internal stem loops",\n      "color": "#167A38",\n      "default_visible": false,\n      "feature": "U2_stem_IIa",\n      "index": 9,\n      "label_model_id": "379.2.4.1",\n      "model_name": "label_09_U2_stem_IIa_res_46_65",\n      "selector_name": "pre_B_8H6E_U2_stem_IIa",\n      "text": "U2 stem IIa (res. 46-65)"\n    },\n    {\n      "atomspec": "#379.1/4A:10",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "379.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#D8C800",\n      "default_visible": false,\n      "feature": "U4_U6_stem_I_partner",\n      "index": 10,\n      "label_model_id": "379.2.2.2",\n      "model_name": "label_10_U4_U6_stem_I_res_1_18",\n      "selector_name": "pre_B_8H6E_U4_U6_stem_I_partner",\n      "text": "U4/U6 stem I (res. 1-18)"\n    },\n    {\n      "atomspec": "#379.1/4A:60",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "379.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#E0CF1A",\n      "default_visible": false,\n      "feature": "U4_U6_stem_II_partner",\n      "index": 11,\n      "label_model_id": "379.2.2.3",\n      "model_name": "label_11_U4_U6_stem_II_res_56_64",\n      "selector_name": "pre_B_8H6E_U4_U6_stem_II_partner",\n      "text": "U4/U6 stem II (res. 56-64)"\n    },\n    {\n      "atomspec": "#379.1/4A:64",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "379.2.5",\n      "category_name": "other snRNA regions",\n      "color": "#F0DF2E",\n      "default_visible": false,\n      "feature": "U4_Brr2_loading_region",\n      "index": 12,\n      "label_model_id": "379.2.5.1",\n      "model_name": "label_12_U4_Brr2_region_res_59_70_73_80_85_94",\n      "selector_name": "pre_B_8H6E_U4_Brr2_loading_region",\n      "text": "U4 Brr2 region (res. 59-70;73-80;85-94)"\n    },\n    {\n      "atomspec": "#379.1/5A:40",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "379.2.3",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#1B3CD0",\n      "default_visible": true,\n      "feature": "U5_loop_I",\n      "index": 13,\n      "label_model_id": "379.2.3.2",\n      "model_name": "label_13_U5_loop_I_res_38_42",\n      "selector_name": "pre_B_8H6E_U5_loop_I",\n      "text": "U5 loop I (res. 38-42)"\n    },\n    {\n      "atomspec": "#379.1/6A:48",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "379.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#D0183C",\n      "default_visible": false,\n      "feature": "U6_U2_helix_I_partner",\n      "index": 14,\n      "label_model_id": "379.2.2.4",\n      "model_name": "label_14_U2_U6_helix_I_res_36_60",\n      "selector_name": "pre_B_8H6E_U6_U2_helix_I_partner",\n      "text": "U2/U6 helix I (res. 36-60)"\n    },\n    {\n      "atomspec": "#379.1/6A:44",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "379.2.3",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#E01842",\n      "default_visible": true,\n      "feature": "U6_5SS_upstream_contact",\n      "index": 15,\n      "label_model_id": "379.2.3.3",\n      "model_name": "label_15_U6_5_SS_contact_res_38_49",\n      "selector_name": "pre_B_8H6E_U6_5SS_upstream_contact",\n      "text": "U6 5\'SS contact (res. 38-49)"\n    },\n    {\n      "atomspec": "#379.1/6A:44",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "379.2.5",\n      "category_name": "other snRNA regions",\n      "color": "#DC143C",\n      "default_visible": false,\n      "feature": "U6_ACAGAGA_box",\n      "index": 16,\n      "label_model_id": "379.2.5.2",\n      "model_name": "label_16_U6_ACAGAGA_res_41_47",\n      "selector_name": "pre_B_8H6E_U6_ACAGAGA_box",\n      "text": "U6 ACAGAGA (res. 41-47)"\n    },\n    {\n      "atomspec": "#379.1/6A:56",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "379.2.5",\n      "category_name": "other snRNA regions",\n      "color": "#E01842",\n      "default_visible": false,\n      "feature": "U6_U4_stem_II_partner",\n      "index": 17,\n      "label_model_id": "379.2.5.3",\n      "model_name": "label_17_U4_U6_stem_II_res_52_61",\n      "selector_name": "pre_B_8H6E_U6_U4_stem_II_partner",\n      "text": "U4/U6 stem II (res. 52-61)"\n    },\n    {\n      "atomspec": "#379.1/6A:68",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "379.2.5",\n      "category_name": "other snRNA regions",\n      "color": "#D9183E",\n      "default_visible": false,\n      "feature": "U6_U4_stem_I_partner",\n      "index": 18,\n      "label_model_id": "379.2.5.4",\n      "model_name": "label_18_U4_U6_stem_I_res_63_74",\n      "selector_name": "pre_B_8H6E_U6_U4_stem_I_partner",\n      "text": "U4/U6 stem I (res. 63-74)"\n    },\n    {\n      "atomspec": "#379.1/6A:90",\n      "category_key": "internal_stem_loops",\n      "category_model_id": "379.2.4",\n      "category_name": "internal stem loops",\n      "color": "#D61A3D",\n      "default_visible": false,\n      "feature": "U6_ISL",\n      "index": 19,\n      "label_model_id": "379.2.4.2",\n      "model_name": "label_19_U6_ISL_res_85_96_102_105",\n      "selector_name": "pre_B_8H6E_U6_ISL",\n      "text": "U6 ISL (res. 85-96;102-105)"\n    },\n    {\n      "atomspec": "#379.1/6A:93",\n      "category_key": "catalytic_core_regions",\n      "category_model_id": "379.2.6",\n      "category_name": "catalytic core regions",\n      "color": "#C91236",\n      "default_visible": false,\n      "feature": "U6_AGC_catalytic_triad",\n      "index": 20,\n      "label_model_id": "379.2.6.1",\n      "model_name": "label_20_U6_AGC_triad_res_92_94",\n      "selector_name": "pre_B_8H6E_U6_AGC_catalytic_triad",\n      "text": "U6 AGC triad (res. 92-94)"\n    }\n  ],\n  "outline_color": "#ffffff",\n  "outline_offsets": [\n    [\n      -0.085,\n      0,\n      0\n    ],\n    [\n      0.085,\n      0,\n      0\n    ],\n    [\n      0,\n      -0.085,\n      0\n    ],\n    [\n      0,\n      0.085,\n      0\n    ],\n    [\n      -0.06,\n      -0.06,\n      0\n    ],\n    [\n      -0.06,\n      0.06,\n      0\n    ],\n    [\n      0.06,\n      -0.06,\n      0\n    ],\n    [\n      0.06,\n      0.06,\n      0\n    ],\n    [\n      -0.052,\n      0,\n      0\n    ],\n    [\n      0.052,\n      0,\n      0\n    ],\n    [\n      0,\n      -0.052,\n      0\n    ],\n    [\n      0,\n      0.052,\n      0\n    ],\n    [\n      -0.037,\n      -0.037,\n      0\n    ],\n    [\n      -0.037,\n      0.037,\n      0\n    ],\n    [\n      0.037,\n      -0.037,\n      0\n    ],\n    [\n      0.037,\n      0.037,\n      0\n    ]\n  ],\n  "size": 144,\n  "structure_model_id": "379.1"\n}'
