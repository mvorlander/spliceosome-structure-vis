...
_EMBEDDED_SPEC = {
  ...
  "labels": [
    ...
    },
    {
      ...
      "model_name": "label_04_BP_region_res_92_98",
      "selector_name": "pre_Bact_8I0P_branch_region",
      "text": "BP region (res. 92-98)"
    },
    {
      "atomspec": "#384.1/G:97",
      "category_key": "pre_mRNA_features",
