...
_EMBEDDED_SPEC = {
  ...
  "selectors": [
    ...
    {
      "atomspec": "#328.1/1,2,3,4,5,6,u,v,w",
      "category": "subcomplex",
      "color": "#6DBE70",
      "comment": "U2/SF3B",
      "family": "Protein/RNP groups",
    ...
    {
      "atomspec": "#328.1/I:60-64,71-79,90-95",
      "category": "snRNA feature",
      "color": "#F0DF2E",
