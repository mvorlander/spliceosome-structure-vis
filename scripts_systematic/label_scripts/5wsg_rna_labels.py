...
_EMBEDDED_SPEC_JSON = '{\n  "background": "none",\n  "cleanup_model_ids": [\n    "318.1.90"\n  ],\n  "default_visible_category_keys": [\n    "pre_mRNA_features",\n    "snRNA_pre_mRNA_regions"\n  ],\n  "default_visible_category_names": [\n    "pre-mRNA features",\n    "snRNA-pre-mRNA regions"\n  ],\n  "height": 3.35,\n  "label_group_model_id": "318.2",\n  "label_group_name": "RNA_feature_labels",\n  "labels": [\n    {\n      "atomspec": "#318.1/M:93",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "318.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#FF8C00",\n      "default_visible": true,\n      "feature": "exon_5",\n      "index": 1,\n      "label_model_id": "318.2.1.1",\n      "model_name": "label_01_5_exon_res_87_99",\n      "selector_name": "Cstar_5WSG_5exon",\n      "text": "5\' exon (res. 87-99)"\n    },\n    {\n      "atomspec": "#318.1/IA:493",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "318.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "intron",\n      "index": 2,\n      "label_model_id": "318.2.1.2",\n      "model_name": "label_02_intron_res_100_114_482_504",\n      "selector_name": "Cstar_5WSG_intron",\n      "text": "intron (res. 100-114;482-504)"\n    },\n    {\n      "atomspec": "#318.1/IA:493",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "318.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "intron_lariat",\n      "index": 3,\n      "label_model_id": "318.2.1.3",\n      "model_name": "label_03_lariat_res_100_114_482_504",\n      "selector_name": "Cstar_5WSG_intron_lariat",\n      "text": "lariat (res. 100-114;482-504)"\n    },\n    {\n      "atomspec": "#318.1/IA:499",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "318.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "branch_point_region",\n      "index": 4,\n      "label_model_id": "318.2.1.4",\n      "model_name": "label_04_BP_region_res_495_503",\n      "selector_name": "Cstar_5WSG_branch_region",\n      "text": "BP region (res. 495-503)"\n    },\n    {\n      "atomspec": "#318.1/IA:501",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "318.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "branch_point_adenosine",\n      "index": 5,\n      "label_model_id": "318.2.1.5",\n      "model_name": "label_05_BP_A_res_501",\n      "selector_name": "Cstar_5WSG_branch_A",\n      "text": "BP-A (res. 501)"\n    },\n    {\n      "atomspec": "#318.1/IB:102",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "318.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#303030",\n      "default_visible": true,\n      "feature": "five_prime_splice_site",\n      "index": 6,\n      "label_model_id": "318.2.1.6",\n      "model_name": "label_06_5_SS_res_100_105",\n      "selector_name": "Cstar_5WSG_5SS",\n      "text": "5\'SS (res. 100-105)"\n    },\n    {\n      "atomspec": "#318.1/IC:2",\n      "category_key": "pre_mRNA_features",\n      "category_model_id": "318.2.1",\n      "category_name": "pre-mRNA features",\n      "color": "#D97706",\n      "default_visible": true,\n      "feature": "exon_3",\n      "index": 7,\n      "label_model_id": "318.2.1.7",\n      "model_name": "label_07_3_exon_res_5_8",\n      "selector_name": "Cstar_5WSG_3exon",\n      "text": "3\' exon (res. -5-8)"\n    },\n    {\n      "atomspec": "#318.1/2:28",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "318.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#047857",\n      "default_visible": false,\n      "feature": "U2_U6_helix_I_partner",\n      "index": 8,\n      "label_model_id": "318.2.2.1",\n      "model_name": "label_08_U2_U6_helix_I_res_26_30",\n      "selector_name": "Cstar_5WSG_U2_U6_helix_I_partner",\n      "text": "U2/U6 helix I (res. 26-30)"\n    },\n    {\n      "atomspec": "#318.1/2:38",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "318.2.3",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#0B6E2D",\n      "default_visible": true,\n      "feature": "U2_branchpoint_pairing_region",\n      "index": 9,\n      "label_model_id": "318.2.3.1",\n      "model_name": "label_09_U2_BP_pairing_res_33_42",\n      "selector_name": "Cstar_5WSG_U2_branchpoint_pairing_region",\n      "text": "U2 BP pairing (res. 33-42)"\n    },\n    {\n      "atomspec": "#318.1/2:49",\n      "category_key": "internal_stem_loops",\n      "category_model_id": "318.2.4",\n      "category_name": "internal stem loops",\n      "color": "#167A38",\n      "default_visible": false,\n      "feature": "U2_stem_IIa",\n      "index": 10,\n      "label_model_id": "318.2.4.1",\n      "model_name": "label_10_U2_stem_IIa_res_46_52",\n      "selector_name": "Cstar_5WSG_U2_stem_IIa",\n      "text": "U2 stem IIa (res. 46-52)"\n    },\n    {\n      "atomspec": "#318.1/5:54",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "318.2.3",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#1B3CD0",\n      "default_visible": true,\n      "feature": "U5_loop_I",\n      "index": 11,\n      "label_model_id": "318.2.3.2",\n      "model_name": "label_11_U5_loop_I_res_53_55",\n      "selector_name": "Cstar_5WSG_U5_loop_I",\n      "text": "U5 loop I (res. 53-55)"\n    },\n    {\n      "atomspec": "#318.1/6:16",\n      "category_key": "internal_stem_loops",\n      "category_model_id": "318.2.4",\n      "category_name": "internal stem loops",\n      "color": "#DC143C",\n      "default_visible": false,\n      "feature": "U6_5prime_terminal_stem_loop",\n      "index": 12,\n      "label_model_id": "318.2.4.2",\n      "model_name": "label_12_U6_5_terminal_SL_res_1_30",\n      "selector_name": "Cstar_5WSG_U6_5_terminal_stem_loop",\n      "text": "U6 5\' terminal SL (res. 1-30)"\n    },\n    {\n      "atomspec": "#318.1/6:54",\n      "category_key": "snRNA_snRNA_regions",\n      "category_model_id": "318.2.2",\n      "category_name": "snRNA-snRNA interacting regions",\n      "color": "#D0183C",\n      "default_visible": false,\n      "feature": "U6_U2_helix_I_partner",\n      "index": 13,\n      "label_model_id": "318.2.2.2",\n      "model_name": "label_13_U2_U6_helix_I_res_41_66",\n      "selector_name": "Cstar_5WSG_U6_U2_helix_I_partner",\n      "text": "U2/U6 helix I (res. 41-66)"\n    },\n    {\n      "atomspec": "#318.1/6:50",\n      "category_key": "snRNA_pre_mRNA_regions",\n      "category_model_id": "318.2.3",\n      "category_name": "snRNA-pre-mRNA regions",\n      "color": "#E01842",\n      "default_visible": true,\n      "feature": "U6_5SS_upstream_contact",\n      "index": 14,\n      "label_model_id": "318.2.3.3",\n      "model_name": "label_14_U6_5_SS_contact_res_44_55",\n      "selector_name": "Cstar_5WSG_U6_5SS_upstream_contact",\n      "text": "U6 5\'SS contact (res. 44-55)"\n    },\n    {\n      "atomspec": "#318.1/6:60",\n      "category_key": "internal_stem_loops",\n      "category_model_id": "318.2.4",\n      "category_name": "internal stem loops",\n      "color": "#D61A3D",\n      "default_visible": false,\n      "feature": "U6_ISL",\n      "index": 15,\n      "label_model_id": "318.2.4.3",\n      "model_name": "label_15_U6_ISL_res_46_73",\n      "selector_name": "Cstar_5WSG_U6_ISL",\n      "text": "U6 ISL (res. 46-73)"\n    },\n    {\n      "atomspec": "#318.1/6:50",\n      "category_key": "other_snRNA_regions",\n      "category_model_id": "318.2.5",\n      "category_name": "other snRNA regions",\n      "color": "#DC143C",\n      "default_visible": false,\n      "feature": "U6_ACAGAGA_box",\n      "index": 16,\n      "label_model_id": "318.2.5.1",\n      "model_name": "label_16_U6_ACAGAGA_res_47_53",\n      "selector_name": "Cstar_5WSG_U6_ACAGAGA_box",\n      "text": "U6 ACAGAGA (res. 47-53)"\n    },\n    {\n      "atomspec": "#318.1/6:60",\n      "category_key": "catalytic_core_regions",\n      "category_model_id": "318.2.6",\n      "category_name": "catalytic core regions",\n      "color": "#C91236",\n      "default_visible": false,\n      "feature": "U6_AGC_catalytic_triad",\n      "index": 17,\n      "label_model_id": "318.2.6.1",\n      "model_name": "label_17_U6_AGC_triad_res_59_61",\n      "selector_name": "Cstar_5WSG_U6_AGC_catalytic_triad",\n      "text": "U6 AGC triad (res. 59-61)"\n    }\n  ],\n  "outline_color": "#ffffff",\n  "outline_offsets": [\n    [\n      -0.085,\n      0,\n      0\n    ],\n    [\n      0.085,\n      0,\n      0\n    ],\n    [\n      0,\n      -0.085,\n      0\n    ],\n    [\n      0,\n      0.085,\n      0\n    ],\n    [\n      -0.06,\n      -0.06,\n      0\n    ],\n    [\n      -0.06,\n      0.06,\n      0\n    ],\n    [\n      0.06,\n      -0.06,\n      0\n    ],\n    [\n      0.06,\n      0.06,\n      0\n    ],\n    [\n      -0.052,\n      0,\n      0\n    ],\n    [\n      0.052,\n      0,\n      0\n    ],\n    [\n      0,\n      -0.052,\n      0\n    ],\n    [\n      0,\n      0.052,\n      0\n    ],\n    [\n      -0.037,\n      -0.037,\n      0\n    ],\n    [\n      -0.037,\n      0.037,\n      0\n    ],\n    [\n      0.037,\n      -0.037,\n      0\n    ],\n    [\n      0.037,\n      0.037,\n      0\n    ]\n  ],\n  "size": 144,\n  "structure_model_id": "318.1"\n}'
