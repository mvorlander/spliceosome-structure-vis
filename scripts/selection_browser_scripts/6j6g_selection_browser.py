...
_EMBEDDED_SPEC = {
  ...
  "selectors": [
    ...
    {
      "atomspec": "#340.1/H,I,P,Q,R,T,d,v",
      "category": "subcomplex",
      "color": "#F4BF67",
    ...
    {
      "atomspec": "#340.1/B:-12-17",
      "category": "substrate RNA feature",
      "color": "#FF8C00",
      "comment": "5' exon: residues -12-17, splice-site-inference, medium confidence, validation not_applicable",
      "family": "RNA",
      "feature": "exon_5",
      "group": "pre-mRNA features",
    ...
    {
      "atomspec": "#340.1/B:-12-17,247-276",
      "category": "substrate RNA feature",
      "color": "#303030",
    ...
    {
      "atomspec": "#340.1/B:247-276",
      "category": "substrate RNA feature",
      "color": "#303030",
      "comment": "intron: residues 247-276, splice-site-inference, medium confidence, validation not_applicable",
      "family": "RNA",
      "feature": "intron",
      "group": "pre-mRNA features",
      "group_key": "pre_mRNA_features",
    ...
    {
      "atomspec": "#340.1/L:46-52,54-63,66-75,78-80",
      "category": "snRNA feature",
      "color": "#167A38",
